...
result = ["Пам парам", "Парам пам-пам"]
quantity = set()

for fraza in input("Введите свой ритмичный стих, Винни-Пух: ").lower().split():
    quantity.add(len(list(filter(lambda sym: 'а и у э о ы я ю ё'.find(sym) != -1, fraza))))
print(result[int(len(quantity) == 1)])